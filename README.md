...
```html
<div align="center"><img src="https://latex.codecogs.com/svg.image?%5Cbg_white%20%5Cmathbb%7BR%7D%5Cleft%20(%20Q%20%5Cright%20)=%20%5Cbegin%7Bbmatrix%7D%202%5Cleft%20(%20q_%7B0%7D%5E%7B2%7D%20&plus;%20q_%7B1%7D%5E%7B2%7D%20%5Cright%20)%20-%201&%202%5Cleft%20(%20q_%7B1%7Dq_%7B2%7D%20-%20%20q_%7B0%7Dq_%7B3%7D%20%5Cright%20)%20&%202%5Cleft%20(%20q_%7B1%7Dq_%7B3%7D%20&plus;%20%20q_%7B0%7Dq_%7B2%7D%20%5Cright%20)%20%5C%5C2%5Cleft%20(%20q_%7B1%7Dq_%7B2%7D%20&plus;%20%20q_%7B0%7Dq_%7B3%7D%20%5Cright%20)%20&%202%5Cleft%20(%20q_%7B0%7D%5E%7B2%7D%20&plus;%20q_%7B2%7D%5E%7B2%7D%20%5Cright%20)%20-%201%20&%202%5Cleft%20(%20q_%7B2%7Dq_%7B3%7D%20-%20%20q_%7B0%7Dq_%7B1%7D%20%5Cright%20)%20%5C%5C2%5Cleft%20(%20q_%7B1%7Dq_%7B3%7D%20-%20%20q_%7B0%7Dq_%7B2%7D%20%5Cright%20)%20&%202%5Cleft%20(%20q_%7B2%7Dq_%7B3%7D%20&plus;%20%20q_%7B0%7Dq_%7B1%7D%20%5Cright%20)%20&%202%5Cleft%20(%20q_%7B0%7D%5E%7B2%7D%20&plus;%20q_%7B3%7D%5E%7B2%7D%20%5Cright%20)%20-%201%20%5C%5C%5Cend%7Bbmatrix%7D"></div>
```

<div align="center"><img src="https://latex.codecogs.com/svg.image?\bg_white&space;\mathbb{R}\left&space;(&space;Q&space;\right&space;)=&space;\begin{bmatrix}&space;2\left&space;(&space;q_{0}^{2}&space;&plus;&space;q_{1}^{2}&space;\right&space;)&space;-&space;1&&space;2\left&space;(&space;q_{1}q_{2}&space;-&space;&space;q_{0}q_{3}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{1}q_{3}&space;&plus;&space;&space;q_{0}q_{2}&space;\right&space;)&space;\\2\left&space;(&space;q_{1}q_{2}&space;&plus;&space;&space;q_{0}q_{3}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{0}^{2}&space;&plus;&space;q_{2}^{2}&space;\right&space;)&space;-&space;1&space;&&space;2\left&space;(&space;q_{2}q_{3}&space;-&space;&space;q_{0}q_{1}&space;\right&space;)&space;\\2\left&space;(&space;q_{1}q_{3}&space;-&space;&space;q_{0}q_{2}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{2}q_{3}&space;&plus;&space;&space;q_{0}q_{1}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{0}^{2}&space;&plus;&space;q_{3}^{2}&space;\right&space;)&space;-&space;1&space;\\\end{bmatrix}" title="\bg_white \mathbb{R}\left ( Q \right )= \begin{bmatrix} 2\left ( q_{0}^{2} + q_{1}^{2} \right ) - 1& 2\left ( q_{1}q_{2} - q_{0}q_{3} \right ) & 2\left ( q_{1}q_{3} + q_{0}q_{2} \right ) \\2\left ( q_{1}q_{2} + q_{0}q_{3} \right ) & 2\left ( q_{0}^{2} + q_{2}^{2} \right ) - 1 & 2\left ( q_{2}q_{3} - q_{0}q_{1} \right ) \\2\left ( q_{1}q_{3} - q_{0}q_{2} \right ) & 2\left ( q_{2}q_{3} + q_{0}q_{1} \right ) & 2\left ( q_{0}^{2} + q_{3}^{2} \right ) - 1 \\\end{bmatrix}" /></div>
