...
<div align="center"><img style="background-color: white;" src="https://latex.codecogs.com/svg.image?\bg_white&space;\mathbb{R}\left&space;(&space;Q&space;\right&space;)=&space;\begin{bmatrix}&space;2\left&space;(&space;q_{0}^{2}&space;&plus;&space;q_{1}^{2}&space;\right&space;)&space;-&space;1&&space;2\left&space;(&space;q_{1}q_{2}&space;-&space;&space;q_{0}q_{3}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{1}q_{3}&space;&plus;&space;&space;q_{0}q_{2}&space;\right&space;)&space;\\2\left&space;(&space;q_{1}q_{2}&space;&plus;&space;&space;q_{0}q_{3}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{0}^{2}&space;&plus;&space;q_{2}^{2}&space;\right&space;)&space;-&space;1&space;&&space;2\left&space;(&space;q_{2}q_{3}&space;-&space;&space;q_{0}q_{1}&space;\right&space;)&space;\\2\left&space;(&space;q_{1}q_{3}&space;-&space;&space;q_{0}q_{2}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{2}q_{3}&space;&plus;&space;&space;q_{0}q_{1}&space;\right&space;)&space;&&space;2\left&space;(&space;q_{0}^{2}&space;&plus;&space;q_{3}^{2}&space;\right&space;)&space;-&space;1&space;\\\end{bmatrix}" title="\bg_white \mathbb{R}\left ( Q \right )= \begin{bmatrix} 2\left ( q_{0}^{2} + q_{1}^{2} \right ) - 1& 2\left ( q_{1}q_{2} - q_{0}q_{3} \right ) & 2\left ( q_{1}q_{3} + q_{0}q_{2} \right ) \\2\left ( q_{1}q_{2} + q_{0}q_{3} \right ) & 2\left ( q_{0}^{2} + q_{2}^{2} \right ) - 1 & 2\left ( q_{2}q_{3} - q_{0}q_{1} \right ) \\2\left ( q_{1}q_{3} - q_{0}q_{2} \right ) & 2\left ( q_{2}q_{3} + q_{0}q_{1} \right ) & 2\left ( q_{0}^{2} + q_{3}^{2} \right ) - 1 \\\end{bmatrix}" /></div>
